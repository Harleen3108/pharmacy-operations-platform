        ...
        <header className="h-20 bg-white border-b border-slate-100 px-8 flex items-center justify-between sticky top-0 z-10 text-outfit">
          ...
          <div className="flex-1 max-w-xl mx-8">
            ...
            <div className="flex flex-col items-end gap-0.5 ml-2">
              <span className="text-[11px] font-black text-[#111827] leading-none">{fullName || 'User'}</span>
              <span className="text-[9px] font-bold text-emerald-600 uppercase tracking-widest">{portalName}</span>
            </div>
